...
saveRDS(table_best_hyperparameters, file = "../../gen/paper/input/table_corr_price_apartment.rds")
saveRDS(table_best_iteration, file = "../../gen/paper/input/table_corr_price_host.rds")
saveRDS(table_model_performance_metrics_training, file = "../../gen/paper/input/table_higher_diff_amenities.rds")
saveRDS(table_model_performance_metrics_testing, file = "../../gen/paper/input/table_expensive_property_type.rds")
saveRDS(plot_model_visualization, file = "../../gen/paper/input/table_cheap_property_type.rds")
saveRDS(features_importance_plot, file = "../../gen/paper/input/table_expensive_neighbourhood.rds")
```
