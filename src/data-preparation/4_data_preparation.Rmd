...
To improve clarity, we created a table displaying, in descending order, the pairs of numeric variables with a mutual correlation higher than 0.75. This table helps in identifying highly correlated variables for potential removal to avoid multicollinearity in regression analysis.
```{r, include=FALSE}
...
saveRDS(table_high_correlation_pairs, file = "../../gen/paper/input/table_high_correlation_pairs.rds")
saveRDS(price_skew, file = "../../gen/paper/input/price_skew.rds")
saveRDS(log_price_skew, file = "../../gen/paper/input/log_price_skew.rds")
saveRDS(plot_skew_log_price, file = "../../gen/paper/input/plot_skew_log_price.rds")
```
