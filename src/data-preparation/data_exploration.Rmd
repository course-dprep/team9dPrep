...
t8 <- head(corr_data, 5) %>%
  ...
  tab_header(
    ...
    subtitle = "First 5 Rows of Correlation Data",
  )
```
...
```{r, include=FALSE}
rm(corr_data, corr_matrix, t8, p6, t9, corr_matrix_df, my_colors)
```
...
t10 <- head(corr_data, 5) %>%
  ...
  tab_header(
    title = "Table of Host-related Variables",
...
```{r, include=FALSE}
rm(corr_data, corr_matrix, t10, p7, t11, corr_matrix_df, my_colors)
```
