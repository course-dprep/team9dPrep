...
# Overview
The code in this replication package constructs the analysis file from the data source ([Milan listings.csv from InsideAirbnb](http://insideairbnb.com/get-the-data/)) using R. Six main code files (5 in _RMarkdown_, 1 in _plain R_) run all of the code to generate the data in the paper (generated by the seventh and last code file in _RMarkdown_). The replicator should expect the code to run for about 4 hours.
